            ...
            btn = function (message) {
                if (message == 1) {
                    ...
                    document.getElementById("text").innerHTML =
                        ...
                        "Over mij: <br> Effectief en een beetje een perfectionist. Als ik bezig ben met iets ga ik ook uiterst mijn best doen om het op een topniveau te leveren <br><br>" +
